...
//
// Em ambiente serverless (Vercel), o pdfjs normalmente carregaria seu "worker" (o módulo que faz
// o parsing de fato) resolvendo o caminho do arquivo em tempo de execução — mas o empacotador da
// Vercel não enxerga essa referência dinâmica interna do pdfjs e não inclui o arquivo do worker no
// pacote publicado, causando 'Setting up fake worker failed: Cannot find module ...pdf.worker.mjs'.
// O pdfjs primeiro verifica `globalThis.pdfjsWorker`: se já estiver setado, usa ele direto e nem
// tenta resolver o arquivo sozinho. Por isso importamos o worker explicitamente aqui (import()
// com caminho literal, que o empacotador da Vercel consegue rastrear e incluir no pacote) e o
// registramos em globalThis antes de qualquer getDocument().
